...
public class EmployeeBean {
  ...
  /*  private List<EmployeeDeptXref> employeeDeptXrefList;
	private List<EmployeeDesignationXref> employeeDesignationXrefList;
	...
	public List<EmployeeDesignationXref> getEmployeeDesignationXrefList() {
		return employeeDesignationXrefList;
	}
    public void setEmployeeDesignationXrefList(List<EmployeeDesignationXref> employeeDesignationXrefList) {
		this.employeeDesignationXrefList = employeeDesignationXrefList;
	}*/
